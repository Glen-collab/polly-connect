...
"button,input[type=submit]{width:100%;padding:14px;margin:8px 0;border:none;border-radius:8px;font-size:18px;cursor:pointer;}"
...
"<button type='button' class='scan-btn' onclick='scan()'>Scan for Networks</button>"
"<div id='nets'></div>"
"<form method='POST' action='/connect'>"
"<h2>WiFi Network</h2>"
"<input name='ssid' id='ssid' placeholder='Network name (SSID)' required>"
"<input name='password' type='password' placeholder='Password'>"
"<input type='submit' class='connect-btn' value='Connect'>"
"</form>"
...
"<input name='claim_code' class='claim-input' placeholder='000000' maxlength='6' inputmode='numeric' pattern='[0-9]{6}' required>"
"<h2>WiFi Network</h2>"
"<input name='ssid' id='ssid' placeholder='Network name (SSID)' required>"
"<input name='password' type='password' placeholder='Password'>"
"<input type='submit' class='connect-btn' value='Connect'>"
