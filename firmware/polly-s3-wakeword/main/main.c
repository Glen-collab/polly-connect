...
{
    // Smooth breathing effect: fade up and down while in WHITE_PULSE state
    int brightness = 0;
    int direction = 2;  // step size per tick
    while (1) {
        ...
        vTaskDelay(pdMS_TO_TICKS(30));  // ~33fps, smooth pulse
    }
}
