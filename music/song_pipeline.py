...
then generates audio via the ElevenLabs Music API.

Drop into your polly-connect Flask app and register the blueprint.
"""
...
def generate_audio(lyrics_data: dict, style_prompt: str) -> bytes:
    """
